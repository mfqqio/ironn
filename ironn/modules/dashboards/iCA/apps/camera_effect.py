...
camera_feat =  ["Camera Model","Focal Length","Lens Aperture",
                "Zoom-in Degree","Exposure Time", "Megapixel", "Pixel Size"]
app.layout = html.Div([
    html.Div([
        html.P("User ID: ",
        ...
        dcc.Input(id='userid_ce', type='text', value='',
    ...
    html.Div([
        ...
        html.P("Select a camera feature", style={'font-weight': 'bold', 'margin-bottom': '3px',"margin-top":"3px", "font-size":"23px"}),
        dcc.Dropdown(
            id="cam_feat_ce",
        ...
        html.P("Select camera feature values", style={'font-weight': 'bold', 'margin-bottom': '4px',"font-size":"23px"}),
        dcc.Dropdown(
            id="cam_feat_val_ce",
            multi=True,
            style={"margin-top":"10px","margin-bottom":"4px", "width":"95%", "font-size":"15px", "padding":"0 0 5px 0"}
        ),
    ...
    ], style={'display':'inline-block','padding': '20px 10px 0px 0px',"width":"46%","margin-bottom":'20px'}),
